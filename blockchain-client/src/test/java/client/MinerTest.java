...
class MinerTest {
    ...
    public static final String PREV_HASH = "6981be29c36bb201f7fbbb26ac324c85b3115df96043882cdd7072147e1e9d3c\n" +
    ...
    @BeforeEach
    void setUp() {
        BlockchainData data = new BlockchainData(2, new ArrayList<>(), 3, PREV_HASH);
        try {
