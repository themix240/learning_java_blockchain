...
import static blockchainnode.HEADERS.*;
...
public class ClientThread implements Runnable {
    ...
    private void generateCoinbase(Block b) {
        Transaction coinbase = new Transaction(null, user.publicKey, 100);
        coinbase.setId(0);
    ...
    private int calculateWallet() {
        return bc.getWallet(user.publicKey);
    }
...
//TODO generate transaction
        ...
        assert r != null;
        Transaction t = new Transaction(user.publicKey, r.publicKey, ammount);
